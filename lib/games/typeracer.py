...
class TypeRacer:
    ...
    def get_words_lst(self):
        found = False
        while not found:
            words_lst = r.get_random_words(
                limit=self.num_words, hasDictionaryDef="true"
            )
    ...
    def process_answer(self, msg):
        ...
        embed = (
            Embed(title="The word was:", description=self.curr_word)
            .set_author(
                name=f"{username} got it right!", icon_url=msg.author.avatar_url
            )
    ...
    def get_word_embed(self):
        ...
        embed = (
            Embed(title="The word is:", description="`" + word_display + "`")
            .set_author(
                name="Type the word!",
    ...
    def get_scoreboard_embed(self):
        ...
        for i in range(len(scoreboard_lst)):
            ...
            embed.add_field(
                ...
                value=f"**{score} words** *+{payment} Coins*",
                inline=False,
            )
        return embed
